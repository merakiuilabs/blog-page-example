<template>
    <nav class="flex flex-col bg-white px-6 py-4 shadow-md md:flex-row md:items-center md:justify-between">
        <div class="flex justify-between items-center">
            <div>
                <a class="text-gray-800 text-2xl font-bold md:text-3xl" href="#">Brand</a>
            </div>
            <div>
                <button type="button" @click="isOpen = !isOpen" class="block text-gray-800 hover:text-gray-700 focus:text-gray-700 focus:outline-none md:hidden">
